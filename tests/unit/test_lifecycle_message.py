...
def test_valid_lifecycle_message_deserializes():
    serialized = b'{"messageId":"cc88a2c9-7e47-409f-82c5-ef49914ae140","contentType":"application/json","payload":"payload","headers":{"source":"source","destination":"destination","service_version":"0.0.1","sdk_version":"0.5.0","created_at":"2024-01-19T20:21:14.045591Z","lifecycle_type":0}}'
...
def test_unusual_lifecycle_message_deserializes():
    serialized = b'{"messageId":"cc88a2c9-7e47-409f-82c5-ef49914ae140","contentType":"application/json","payload":"payload","headers":{"source":"source.one","destination":"destination.two","service_version":"0.0.1","sdk_version":"0.5.0","created_at":"2024","lifecycle_type":0}}'
    deserialized = deserialize_and_validate_lifecycle_message(serialized)
    assert deserialized['headers']['lifecycle_type'] == LifecycleType.STARTUP
    assert deserialized['contentType'] == 'application/json'
...
def test_invalid_does_not_deserialize():
    serialized = b'{"messageId":"notauuid","contentType":"doesnotexist","payload":"payload","headers":{"source":"/","destination":"/","service_version":"1.0.0-alpha","sdk_version":"1.0.0+20130313144700","created_at":"2024-01-19T20:21:14.045591","lifecycle_type":-1}}'
    with pytest.raises(ValidationError) as err:
        deserialize_and_validate_lifecycle_message(serialized)
