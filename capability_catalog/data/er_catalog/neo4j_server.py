...
from capability_catalog.data.er_catalog.neo4j_service import ERCatalogCapability
...
if __name__ == '__main__':
    ...
    my_sub_name : str = getenv("INTERSECT_SUBSYSTEM_NAME", "data-management") 
    my_svc_name : str = getenv("INTERSECT_SERVICE_NAME", "er-catalog")
    ...
    er_capability = ERCatalogCapability(service_hierarchy=config.hierarchy)
    all_caps = [avail_status_capability, er_capability]
