...
from capability_catalog.system.system_manager.service import SystemManagerCapability
...
if __name__ == '__main__':
    ...
    my_svc_name : str = getenv("INTERSECT_SERVICE_NAME", "system-manager")
    ...
    sys_info_capability = SystemInformationCatalogCapability(service_hierarchy=config.hierarchy,
                                                             system=my_system)
    sys_mgr_capability = SystemManagerCapability(service_hierarchy=config.hierarchy,
                                                 system=my_system)
    all_caps = [avail_status_capability, sys_mgr_capability, sys_info_capability]
